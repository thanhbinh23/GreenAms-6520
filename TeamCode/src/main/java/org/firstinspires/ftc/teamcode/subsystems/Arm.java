...
public class Arm {
    ...
    public void initArm() {
        ...
        turretMotor.setTargetPositionTolerance((int) (Math.PI / 90 * Constants.AUTONOMOUS.ARM.CORE_HEX_TICKS_TO_RADIAN));
    }
    ...
    public void TurretTurnAngle(double angle, double speed) {
        ...
        turretMotor.setTargetPosition((int) (angle * Constants.AUTONOMOUS.ARM.CORE_HEX_TICKS_TO_RADIAN));
    ...
    public void ArmMoving(double angle, double speed) {
        ...
        armMotor.setTargetPosition((int) (angle * Constants.AUTONOMOUS.ARM.CORE_HEX_TICKS_TO_RADIAN));
